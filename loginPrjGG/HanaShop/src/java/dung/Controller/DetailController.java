...
public class DetailController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
     ...
     try {
            ...
            FoodDto dto = dao.loadDetail(id);
            CategoryDao cateDao = new CategoryDao();
            List<CategoryDto> listCate = cateDao.loadCategory();
            String categoryName = cateDao.findCateName(dto.getCategoryID());
            request.setAttribute("DETAIL",dto);
            request.setAttribute("LISTCATE", listCate);
            request.setAttribute("NAMECATE", categoryName);

        } catch (Exception e) {
            log("Error at details controller" + e.getMessage());
        }
